...
if N==1                 % one observation along chosed DIM, return defaults
   ...
   in=isnan(x);
   s=struct('n',double(~in),'nan',double(in),'min',x,'q1',x,'q1b', x,'median',x,...
            'q3',x,'q3b',x,'max',x,'mode',x,'mean',x,'std',sv,'var',sv,...
            'skew',sv,'kurt',sv);
   return
else                                             % create struct for output
   s=struct('n',[],'nan',[],'min',[],'q1',[],'q1b',[],'median',[],'q3',[],'q3b',[],'max',[],...
